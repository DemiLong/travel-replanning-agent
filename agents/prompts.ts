...
11. Write all human-readable fields (summary, explanation, reason, note and constraint) in concise Simplified Chinese. Keep canonical place names and district values exactly as supplied when they are used for identity or validation.
